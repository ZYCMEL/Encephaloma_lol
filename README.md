...
Graph 1 used grouping to show a positive correlation between age and the average glucose level. Along with a correlation analysis on the subject showing fairly strong positive correlations. 

Interestingly, using filters we could conclude that graph 2 showed a negative correlation of smoking to the occurrences of heart diseases. This pretty counter-intuitive and could be a result of the limited data size.

Graph 3 is a simple line graph that showed the positive correlations between hypertensions and strokes. This quite natural to assume and the correlation analysis revealed moderate positive correlations between the two.

Lastly, Graph 4 showed a distribution of BMI according to the type of work the respondent did. With Stay at home having a more significant right skew and private work providing the most data and being much more bell shaped.
